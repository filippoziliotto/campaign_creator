...
- Come si inserisce {{ twist_reference }} e in quale momento cambia tutto?
- Perché funziona in una singola sessione da 3–5 ore?

> Non ignorare le impostazioni selezionate. Se intravedi una variante piu forte, usala solo se resta coerente con i dati scelti e spiega perche funziona meglio.
...
3–5 righe. Cosa sta succedendo quando i PG entrano in scena? Qual è la posta immediata? Come cambia tutto con {{ twist_reference }}?
...
**Vincolo:** almeno una scena deve anticipare {{ twist_reference }} con un indizio ambientale — non dialogato. Marcala con ★.
